...
// 이번 추첨에는 총
// N마리의 소가 응모했다. 헛간은
// W * H 크기의 직사각형이다. 베시는 소 한 마리당
// L * L 크기의 공간을 배정할 계획이다.
...
// 입력
// 소들의 수 N, 헛간의 크기 W * H를 나타내는 두 정수
// W와 H, 그리고 소들에게 배정되는 공간의 크기 L이 순서대로 주어진다.
