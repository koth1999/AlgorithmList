...
public class UCPC {
    ...
    public static boolean isUCPC(String word) {
        int indexU = word.indexOf("U");
        int indexC1 = word.indexOf("C", indexU + 1);
        int indexP = word.indexOf("P", indexC1 + 1);
        int indexC2 = word.indexOf("C", indexP + 1);

        return indexU != -1 && indexC1 != -1 && indexP != -1 && indexC2 != -1;
    }
}
