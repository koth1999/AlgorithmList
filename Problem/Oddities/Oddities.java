package Problem.Oddities;

// Some numbers are just, well, odd. For example, the number 3 is odd,
// because it is not a multiple of two. Numbers that are a multiple of two are not odd,
// they are even. More precisely, if a number n can be expressed as n = 2 * k for some integer k, then n is even.
// For example, 6 = 2 ∗ 3 is even. Some people get confused about whether numbers are odd or even.
