...
// 입력 : 300 4 1000         입력 : 20 6 120         입력 : 20 10 320
// 출력 : 200                출력 : 0                입력 : 0
...
public class Snack {
    public static void main(String[] args) {
        ...
        int snack = sc.nextInt(); // 과자 1개 가격
        int cnt = sc.nextInt(); // 과자 개수
        int money = sc.nextInt(); // 가지고 있는 돈

        int total = snack * cnt - money; // 부모님께 받아야할 돈

        if(total > 0) {
            System.out.println(total);
        }else if(total == 0 || total < 0) { // 받아야할 돈이 0이거나 0보다 작은 경우
