...
public class CopyRight {
    public static void main(String[] args) {
        ...
        int songs = sc.nextInt(); // 앨범 수록된 곡
        int avgMelodies = sc.nextInt(); // 평균 멜로디 수

        // avgMelodies -1 : 각 곡마다 평균보다 1만큼 적은 멜로디 수를 더해서 전체 곡의 멜로디 수를 구함
        // songs * (avgMelodies -1) : 앨범에 수록된 곡 수와 각 곡에 대한 추가적인 멜로디 수를 곱하여 전체 멜로디 수의 예상값을 구함
        int melodies = songs * (avgMelodies-1) + 1;
        System.out.print(melodies);
    }
}
