...
// 자동차에 여러 가지 옵션을 포함시킬 수 있는데 해빈이는 덧셈과 곱셈을 하지 못하기 때문에 친구 태완이에게 도움을 청했다. 하지만 태완이도 덧셈과 곱셈을 못한다.
...
public class HowMuch {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < t; i++) {
            int s = sc.nextInt();
            int total = s; // 각 테스트 케이스마다 초기 자동차 가격을 total에 저장

            int n = sc.nextInt();
            for(int j = 0; j < n; j++) {
                int q = sc.nextInt(); // 옵션 개수
