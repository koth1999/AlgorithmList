...
// 최초 1년째는 "갑자"이고, 2년째는 "을축", 3년째는 "병인" 과 같이 올해의 간지에서 십간과 십이지의 다음 문자를 이듬해의 간지로 사용한다.
// 십간은 10년을 주기로, 십이지는 12년을 주기로 순환된다. 이런 순서로 하여 마지막 "계해"는 60년째를 나타내고, 61년째는 다시 "갑자"가 된다.
// 60갑자를 서양식으로 나타내기 위해 십간을 0부터 9까지의 정수로 표현하고
// 십이지를 "ABCDEFGHIJKL"로 표현하고 십간과 십이지의 순서를 바꾼다고 하자.
...
public class GanZi {
    public static void main(String[] args) {
        ...
        System.out.print(zi[(year + 8) % 12]); // 중국의 띠 계산
        System.out.print(gan[(year + 6) % 10]); // 중국의 천간 주기 계산
    }
}
